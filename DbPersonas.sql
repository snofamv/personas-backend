SET foreign_key_checks = 0; -- Desactivar las comprobaciones de claves foráneas
DROP TABLE IF EXISTS `comunas`;
DROP TABLE IF EXISTS `provincias`;
DROP TABLE IF EXISTS `regiones`;
DROP TABLE IF EXISTS `personas`;
DROP TABLE IF EXISTS `detalles_personas`;
DROP TABLE IF EXISTS comunas;
...
DROP TABLE IF EXISTS `estados_cv`;
CREATE TABLE `estados_cv` (
...
create table personas(
    ...
    rut varchar(8) null unique,
    dv char(1) null,
    nombre varchar (36) not null,
    apaterno varchar(36) not null,
    amaterno varchar(36) not null,
    fec_nac DATE not null,
    sexo char(1) null, -- M para masculino, F para femenino, NB para NoBinario
    nacionalidad varchar(36) null,
    activo boolean null default false,
    estado_cv int null default 1,
    primary key(id),
    FOREIGN KEY (estado_cv) REFERENCES estados_cv(id) on delete cascade on update cascade
)ENGINE=InnoDB;

ALTER TABLE provincias
ADD FOREIGN KEY (region_id) REFERENCES regiones(region_id);
ALTER TABLE comunas
ADD FOREIGN KEY (provincia_id) REFERENCES provincias(provincia_id);


 -- Inserts to ESTADOS CV
INSERT INTO estados_cv (estado) VALUES ('Soltero'),('Casado'),('Viudo'),('Divorciado');


-- --PERSONAS
INSERT INTO personas (id, rut, dv, nombre, apaterno, amaterno, fec_nac, sexo, nacionalidad, estado_cv)
VALUES ('4fa3a0ed-1b2d-4ed6-9a82-bd6b1b12f0d5', '12345678', '9', 'Juan', 'Perez', 'Gonzalez', '1980-05-15', 'M', 'Chile', 1);

INSERT INTO personas (id, rut, dv, nombre, apaterno, amaterno, fec_nac, sexo, nacionalidad, estado_cv)
VALUES ('9b98b013-df2d-49a9-b76d-e8dcd86e7fd6', '23456789', 'K', 'Ana', 'Lopez', 'Martinez', '1992-08-22', 'F', 'Chile', 1);
